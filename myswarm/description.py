...
'/home/flarelink/.local/lib/python2.7/site-packages/nupic/swarming/exp_generator/experiment_generator.pyc'
"""
...
control = {
  ...
  'dataset' : {   'aggregation': config['aggregationInfo'],
        ...
        u'streams': [   {   u'columns': [u'*'],
                            u'info': u'machine_temperature_system_failure.csv',
                            u'last_record': 100,
                            u'source': u'file://data/machine_temperature_system_failure.csv'}],
        u'version': 1},
 ...
 u'predictionSteps': [1]},
  ...
  'metrics':[
    MetricSpec(field=u'value', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'aae'}),
    MetricSpec(field=u'value', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1], 'errorMetric': 'altMAPE'})
  ],
